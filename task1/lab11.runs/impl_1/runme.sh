...
HD_PWD='C:/Users/ikhla/Desktop/semester 4/CA/project/test2/task1/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscV_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscV_processor.tcl -notrace
